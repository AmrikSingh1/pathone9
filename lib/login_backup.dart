...
class _LoginPageState extends State<LoginPage> with TickerProviderStateMixin {
  ...
  void _navigateToLoginContent({bool isLoginMode = true}) {
    ...
    // Adjust container position based on form type
    _animateFormContentOffset(isLoginMode ? 20.0 : 50.0);
  ...
  // Add this method for phone verification
  void _getVerificationCode() {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Verification code sent! For demo, use code: 123456'),
  ...
  void _verifyOtpCode() {
    ...
    // Simulate verifying code (in a real app, you would verify with Firebase)
    Future.delayed(const Duration(seconds: 2), () {
      if (mounted) {
  ...
  Widget build(BuildContext context) {
    ...
    final optionsHeight = screenHeight * 0.36;
    final loginFormHeight = _isLogin ? screenHeight * 0.76 : screenHeight * 0.90; // Increased height for create account form
    ...
    final keyboardSlideAmount = 160.0 * _keyboardSlideOffset;
          ...
          if (_showOptionsContainer || _showLoginContent)
            Positioned(
              ...
              bottom: -screenHeight * 0.036 * _containerSlidePosition +
                  (_containerExpandPosition * -screenHeight * 0.09) +
                  keyboardSlideAmount +
                  _formContentOffset,
              left: 0,
              right: 0,
                            ...
                            ? FadeTransition(
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  padding: const EdgeInsets.only(
                                    ...
                                    right: 24,
                                    top: 20,
                                    bottom: 30, // Increased bottom padding for better scrolling
                                  ),
                                  child: Form(
                                    key: _formKey,
                                    child: Column(
                                                ...
                                                Container(
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    style: const TextStyle(
                                                      color: Color(0xFF1F2937),
                                                      fontSize: 16,
                                                      letterSpacing: 8, // Spread out the digits for better readability
                                                    ),
                                                    decoration: InputDecoration(
